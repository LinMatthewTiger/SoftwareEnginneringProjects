...
// Changes Made:
//	-Altered initial presents text; Odds are I'll forget and
//	 end up leaving it in the final project.
//	-Changed the title image for the fun of it, see note above

public class OLPresents extends PacmanActor {
    
//    private String text = "O.L. PRESENTS";
    private String text = "HIDEO KOJIMA\n\n PRESENTS";
